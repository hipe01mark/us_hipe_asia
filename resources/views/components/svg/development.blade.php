<svg width="110px" height="110px" viewBox="0 0 64 64" data-name="Layer 1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
    fill="#fff" stroke="#fff">
    ...
    <g id="SVGRepo_iconCarrier">
        <defffs>
            <style>
                .cls-1 {
                    fffill: #fffffffffffffffffffff;
                }

                .cls-2 {
                    fffill: #fffffffffffffffffffff76c5e;
                }
        ...
        <circle class="cls-1" cx="33" cy="32" r="9"></circle>
        <path class="cls-3" d="M7,32c0-14.36,11.64-26,26-26v4c-12.15,0-22,9.85-22,22"></path>
        <polygon class="cls-2" points="9 38 5 32 13 32 9 38"></polygon>
        <path class="cls-3" d="M46,54.51c-12.44,7.18-28.34,2.92-35.52-9.52l3.46-2c6.08,10.52,19.53,14.13,30.05,8.05">
        </path>
        <polygon class="cls-2" points="50.19 49.78 47 56.25 43 49.32 50.19 49.78"></polygon>
        <path class="cls-3" d="M46,9.48c12.44,7.18,16.7,23.08,9.52,35.52l-3.46-2c6.08-10.52,2.47-23.98-8.05-30.05">
        </path>
        <polygon class="cls-2" points="39.8 8.21 47 7.75 43 14.68 39.8 8.21"></polygon>
    </g>
</svg>
